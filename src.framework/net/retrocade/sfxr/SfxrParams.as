...
package net.retrocade.sfxr
{
     ...
     * 
     * @author Thomas Vian, Maurycy Zarzycki
     */
    public class SfxrParams
    {
        ...
        public function set sustainTime(value:Number):void { _sustainTime = value; paramsDirty = true; }
        ...
        public function mutate(mutation:Number = 0.05):void
        {
            ...
            //if (Math.net.retrocade.random() < 0.5) minFrequency +=         Math.net.retrocade.random() * mutation*2 - mutation;
        ...
        /**
         * Sets all parameters to net.retrocade.random values
         */
