package net.retrocade.retrocamel.core {
	...
	public class RetrocamelDisplayManager {
		...
		retrocamel_int static function initializeFlash(main:MovieClip, stage:Stage):void {
			_flashStage = stage;
		...
		public static function setBackgroundColor(color:uint):void{
			...
			_flashApplication.graphics.drawRect(0, 0, RetrocamelCore.settings.swfWidth, RetrocamelCore.settings.swfHeight);
