package net.retrocade.retrocamel.display.flash {
	...
	public class RetrocamelPreciseGrid9 extends RetrocamelSprite {
		...
		public static function getGrid(name:String, dontScale:Boolean = false):RetrocamelPreciseGrid9 {
			...
			newGrid.width = newGrid._minWidth + 1;
			newGrid.height = newGrid._minHeight + 1;
		...
		private function redraw(newWidth:uint, newHeight:uint):void {
			...
			UtilsBitmapData.blit(_bottomLeftBD, _bitmapData, 0, _bitmapData.height - _bottomLeftBD.height);
			UtilsBitmapData.blit(_bottomRightBD, _bitmapData, _bitmapData.width - _bottomRightBD.width, _bitmapData.height - _bottomRightBD.height);
		}
	}
}